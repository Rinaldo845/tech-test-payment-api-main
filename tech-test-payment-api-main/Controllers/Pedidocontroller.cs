    ...
    public class PedidoController : ControllerBase
    {
        ...
        public PedidoController()
        {
            if (ListaPedidos == null)
            {
                ...
                var produto = ProdutoController.ListaProduto.Find(x => x.Nome == "bola de Futebol");
        ...
        public IActionResult Create(string cpfVendedor, int Idp )
        {
            ...
            //var pedidoId = PedidoController.ListaPedidos.Find(x => x.Id == Id);
        ...
        public IActionResult FindById(Guid pedido)
        {
        ...
        public IActionResult MakePayment(Guid pedido, string creditCard)
        {
        ...
        public IActionResult CancelOrder(Guid pedido)
        {
            var ret = ListaPedidos.Find(x => x.Id == pedido);
            if (ret == null)
                return NotFound("Você não informou um pedido válido");
        ...
        public IActionResult SendToTransport(Guid pedido)
        {
            var ret = ListaPedidos.Find(x => x.Id == pedido);
            if (ret == null)
                return NotFound("Você não informou um pedido válido");
        ...
        public IActionResult DeliveryTracking(Guid pedido)
        {
            var ret = ListaPedidos.Find(x => x.Id == pedido);
            if (ret == null)
                return NotFound("Você não informou um pedido válido");
